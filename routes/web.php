...
// Home Controller
Route::get('/', function () { return view('welcome.landingpage'); })->name('home');

// Ruta articulo
Route::get('/article/{id}', function () { return view('common.article'); })->name('article');

Route::middleware('auth')->group(function() {
    // Ruta biblioteca
    Route::get('/library', function () { return view('common.library'); })->name('library');

    // Ruta perfil
    Route::get('/profile', function () { return view('common.profile'); })->name('profile');
