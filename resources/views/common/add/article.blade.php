                ...
                <div class="form-group d-flex flex-column p-4 gap-4">
                    <div class="d-flex gap-4">
                        <div class="container">
                            ...
                            <input id="ArticleTitle" type="text" class="form-control" aria-label="Titulo">
                        </div>
                        
                        <div class="container d-flex flex-column">
                            <label class="form-check-label fs-5" for="ArticleCategory">Categoría</label>
                            <select class="selectpicker w-100" id="ArticleCategory" data-live-search="true" title="Selecciona una de las siguientes...">
        ...
        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
            ...
            <form action="{{ route('updateProfile') }}" method="POST">
                <div class="d-flex flex-column justify-content-center gap-3 p-4">
                    <div class="container">
                        <input type="file" class="form-control" id="ArticlePDF" accept=".pdf" />
                    </div>
...
<script type="text/javascript">
	...
	document.addEventListener("adobe_dc_view_sdk.ready", function(){ 
		...
		}, {embedMode: "IN_LINE", showDownloadPDF: false, showPrintPDF: false}).then(doOnLoad(), doOnFail())
	});
</script>
@endsection